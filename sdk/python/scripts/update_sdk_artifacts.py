...
def checkout_schema_dir() -> Path:
    """Return the app-server schemas generated from this checkout."""
...
def generate_types() -> None:
    """Refresh SDK artifacts from the schemas generated by this checkout."""
    generate_types_from_schema_dir(checkout_schema_dir())
